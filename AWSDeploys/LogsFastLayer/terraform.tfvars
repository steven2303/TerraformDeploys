...
sftp_audit_log_bucket_name = "ue1stgdesaas3ftp001-test" # Debe existir
audit_log_landing_bucket_name    = "ue1stgprdas3log001-test" # Debe existir
sftp_audit_log_bucket_prefixes = ["RAW-SFTP/LOGS/AUDIT_LOG/DELTA/","RAW-SFTP/LOGS/CAT_PRO/"]
audit_log_landing_bucket_prefixes = ["LOGS/AUDIT_LOG/DELTA/","LOGS/CAT_PRO/"]
full_audit_log_key_path = "LOGS/AUDIT_LOG/FULL/"
