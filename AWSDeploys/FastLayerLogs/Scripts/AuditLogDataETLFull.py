...
# Define paths
s3_input_path = "s3://ue1stgprdas3log001-test/LOGS/AUDIT_LOGS/FULL/"
output_dir = "s3://ue1stgprdas3log002/audit-logs/"
date_suffix = datetime.now().strftime("%Y%m%d%H%M")
output_dir_err = "s3://ue1stgprdas3log002/error/historica/"
...
df_nulls_dni = full_filter_dni_nulls(transformed_df)
df_cleaned,df_dni_errors = full_keep_only_numeric(df_filtered, 'nro_dni2')
